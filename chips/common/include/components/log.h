...
#define BK_LOG_DEFAULT 6 /* default level, BK_LOG_INFO in release version, BK_LOG_DEBUG in debug version */
    ...
    #define BK_LOG_LEVEL         BK_LOG_VERBOSE

...
class bk_sdk_project(bk_project):
    ...
    @property
    def custom_project_path(self) -> Path:
        return self._project_info.custom_project_path
    ...
    def get_custom_soc_config_path(self, app_name: str) -> Path:
        assert app_name.endswith("_ap")
        return self.custom_project_path / "boards" / app_name

...
set(ARMINOTOOL ${PYTHON} "$ENV{ARMINO_TOOLS_PATH}/build_tools/armino.py")
...
function(__project_info test_components)
    ...
    configure_file("${armino_tools_path}/build_tools/cmake/project_description.json.in"
...
macro(project project_name)
    ...
    add_custom_command(OUTPUT ${project_elf_src}
		...
		COMMAND ${CMAKE_COMMAND} -E echo "volatile const char build_version[] = __DATE__ \" \" __TIME__;" > ${project_elf_src}
		MAIN_DEPENDENCY ${sdkconfig}
		COMMENT "armino ====> gen file ${CMAKE_BINARY_DIR}/project_elf_src.c..."
        VERBATIM)
    ...
    set(armino_size ${python} ${armino_tools_path}/build_tools/armino_size.py)
